...
<?php
 ...
 include 'dashboardNav.php';
  ...
  ?>
      <form method="POST" action="./MeetingCreator.php" class="w-2/4 mt-8 gap-8 flex flex-col ml-[15em]">


  <div class="form-group">
    <label for="MeetingTitle">Meeting Title</label>
    <input type="text" name="Meeting_title" class="form-control" id="MeetingTitle" aria-describedby="usernameHelp" placeholder="Enter Meeting Title">
  </div>
  
  <div class="form-group">
    <label for="MeetingDuration">Meeting Duration</label>
   <select id="duration" name="Meeting_dur" class="form-control form-control-lg">
  ...
  <div class="form-group">
    ...
    <input name="Meeting_loc" type="text" class="form-control" id="MeetingLocation" aria-describedby="usernameHelp" placeholder="Enter Meeting Location">
  </div>
  
  <div class="form-group">
    <label for="MeetingDay">Meeting Day</label>
    <select name="Meeting_day" class="form-control form-control-lg">
  ...
  <div class="form-group">
    <label for="MeetingDay">Meeting Time</label>
    <select name="Meeting_time" class="form-control form-control-lg">
  ...
  <div class="form-group">
    <label for="MeetingDay">Meeting Time</label>
    <select name="Meeting_endtime" class="form-control form-control-lg">
     <option value="09:00:00" > 09:00 AM</option>
     <option value="10:00:00" >10:00 AM</option>
     <option value="11:00:00" >11:00 AM</option>
     <option value="12:00:00" >12:00 PM</option>
  ...
  <div class="form-group">
    <label for="MeetingDay">Meeting Schedule</label>
    <select id="Meeting_sch" name="Meeting_schedule" class="form-control form-control-lg">
  ...
  <div class="form-group">
    <label for="startdate">Meeting Start Date  </label>
    <input class="form-control form-control-lg" id="startdate" type="date" name="Meeting_startdate" >
  </div> 
  
  <div class="form-group">
    <label for="startdate">Meeting End Date  </label>
    <input class="form-control form-control-lg" type="date" id="enddate" name="Meeting_enddate">
  </div>
  ...
  <button type="submit" id="create" name="create" class="btn btn-primary">Create Meeting</button>
...
let schedule = document.getElementById("Meeting_sch").value
